...
import imageSample from '@/images/photos/sample.jpg'
import imageSample2 from '@/images/photos/sample-2.jpg'
...
<Image src={imagePxDLogo} alt="Precision Development" />

## Project Snapshots

<ImageCarousel
  images={[imageSample, imageSample2, imageSample, imageSample2]}
/>
