...
*While there is value in the items on the right (process & tools, comprehensive documentation, contract negotiation, following a plan), we value the items on the left more (Individual and interactions, working software, customer collaboration, responding to change).*
